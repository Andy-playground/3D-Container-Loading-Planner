...
const dict = {
  'zh-Hant': {
    ...
    nonStackableLabel: '⊘ 不可堆疊（僅放地面，上方不放貨）',
    hintNonStackable: '適用鋰電池、輪組等打棧板出貨的貨物：只放在櫃底地面、上方不放任何貨物。請輸入打棧板後的整體長寬高與總重。',
  ...
  'en': {
    ...
    nonStackableLabel: '⊘ Non-stackable (floor only, nothing on top)',
    hintNonStackable: 'For palletized cargo such as lithium batteries or wheelsets: placed on the container floor only, with nothing ever stacked on top. Enter the palletized overall L×W×H and total weight.',
