...
const dict = {
  'zh-Hant': {
    ...
    unitSystem: '單位',
    fillRule: '填充規則',
    fillMixed: 'mixed（混裝，利用率優先）',
    fillColumn: 'columnFill（同類整列，卸貨優先）',
    isPalletLabel: '▤ 棧板（整板裝載，含子貨物清單）',
    subItemName: '子貨物名稱',
    subItemWeight: '重量／件',
    addSubItem: '+ 加入子貨物',
    palletContents: '棧板內容物',
    subItemsTotal: '子貨物合計',
    unitMetric: '公制 (cm / kg)',
  ...
  'en': {
    ...
    maxLoadOnTopKg: 'Max load on top',
    ...
    unitSystem: 'Units',
    fillRule: 'Fill rule',
    fillMixed: 'mixed (utilization first)',
    fillColumn: 'columnFill (cluster SKUs, unload first)',
    isPalletLabel: '▤ Pallet (loaded as one unit, with contents list)',
    subItemName: 'Sub-item name',
    subItemWeight: 'Weight/pc',
