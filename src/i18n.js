...
const dict = {
  'zh-Hant': {
    ...
    autoChosen: '自動選櫃',
    shipMode: '運輸方式 (Ship Mode)',
    shipModeAll: '不限（所有櫃型）',
    shipModeOcean: '海運 Ocean',
    shipModeTruck: '卡車 Truck',
    shipModeRail: '鐵路 Rail',
    shipModeCustom: '自訂貨櫃',
    noContainersForMode: '此運輸方式沒有可用櫃型',
    importCsv: '匯入 CSV',
  ...
  'en': {
    ...
    shipMode: 'Ship Mode',
    shipModeAll: 'Any (all container types)',
    shipModeOcean: 'Ocean',
    shipModeTruck: 'Truck',
    shipModeRail: 'Rail',
    shipModeCustom: 'Custom containers',
    noContainersForMode: 'No containers available for this ship mode',
